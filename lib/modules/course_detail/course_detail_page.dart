...
class CourseDetailPage extends StatelessWidget {
  ...
  const CourseDetailPage({Key? key, required this.course, required this.service}) : super(key: key);
          ...
          children: [
            FutureBuilder<Teacher?>(
              ...
              builder: (context, snapshot) {
                return Row(children: [const Text("Teacher: "), Text(snapshot.hasData ? snapshot.data!.name : "No teacher yet for this course.")]);
              },
            ),
